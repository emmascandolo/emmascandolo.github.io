...
date: 2024-06-01
description: Student employment increased after the UK removed the means-tested maintenance grant. In my paper I analyse whether the grant removal caused an increase in employment by comparing eligible and ineligible students.
plot: ../../img/employment_ts.png
author:
  - name: Ben Dahmen
...
pub-info:
  links:
    - name: PDF
      url: ../../papers/maintenance_grant.pdf
